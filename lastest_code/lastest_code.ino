...
const char *ssid = "-1/12"; 
const char *password = "12345687";

String postData ; 
String link = "http://192.168.43.64/biometricattendance/getdata.php";
int FingerID = 0;     
uint8_t id;
...
void setup() {
  ...
  //SendFingerprintID( FingerID );//comment later
...
void SendFingerprintID( int finger ) {
  ...
  http.begin("http://192.168.43.64/biometricattendance/getdata.php"); //initiate HTTP request, put your Website URL or Your Computer IP
